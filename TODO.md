...
- [x] Implement `al_merge_config(ALLEGRO_CONFIG*, const ALLEGRO_CONFIG*)` - merge configs
- [x] Implement `al_merge_config_into(ALLEGRO_CONFIG*, const ALLEGRO_CONFIG*)` - merge into
...
- [x] Implement `al_get_fs_entry_name(ALLEGRO_FS_ENTRY*)` - get filename
...
- [x] Implement `al_get_fs_entry_size(ALLEGRO_FS_ENTRY*)` - file size
- [x] Implement `al_update_fs_entry_mode(ALLEGRO_FS_ENTRY*)` - refresh mode
